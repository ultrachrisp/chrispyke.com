...
- Responsible for feature development on customer facing products as well as internal tooling. I also had operational responsibilities which included on-call shifts for the servers and support schedules for customer-support. 
- Due to my adaptability and ability to get up to speed quickly, I moved between teams within the Engineering department. Often the only developer working on front-end related tasks.
- Sought after by the teams I had worked with. I was able to rekindle existing relationships which resulted in faster ramp up times for new initiatives or projects.
- Successfully conceptualized & deployed solutions from loose business requirements, often under tight timelines.
- Successfully executed a number of projects from start to finish. This included bootstrapping new micro front-end frameworks for existing systems as well as decoupling internal systems from larger code bases to allow for faster development cycles.
...
- Established best practices & support for other developers & their teams.
